...
def get_faces(sprite):
    ...
    east.blit(sprite, (0, 0),(tile_size[1], tile_size[1],tile_size[0], tile_size[1]))
    faces["east"] = east 
    ...
    east1.blit(sprite, (0, 0),(0, tile_size[1],tile_size[0], tile_size[1]))
    faces["east1"] = east1 
 
    west1 = pygame.Surface(tile_size, pygame.HWSURFACE|pygame.SRCALPHA)
    west1.blit(sprite, (0, 0),(0,tile_size[1]*2,tile_size[0] ,tile_size[1]))
    faces["west1"] = west1
    ...
    east2.blit(sprite, (0, 0),(tile_size[0]*2, tile_size[1],tile_size[0], tile_size[1]))
    faces["east2"] = east2 

    west2 = pygame.Surface(tile_size, pygame.HWSURFACE|pygame.SRCALPHA)
    west2.blit(sprite, (0, 0),(tile_size[0]*2 ,tile_size[1]*2 ,tile_size[0] ,tile_size[1]))
    faces["west2"] = west2 
